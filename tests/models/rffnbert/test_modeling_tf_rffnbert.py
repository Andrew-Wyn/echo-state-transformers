...
from transformers import RFFNBertConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers.models.rffnbert.modeling_tf_rffnbert import (
...
class TFRFFNBertModelTester:
    ...
    def create_and_check_model(
        ...
        model = TFRFFNBertModel(config=config)
    ...
    def create_and_check_causal_lm_model(
        ...
        model = TFRFFNBertLMHeadModel(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = TFRFFNBertForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_next_sequence_prediction(
        ...
        model = TFRFFNBertForNextSentencePrediction(config=config)
        inputs = {"input_ids": input_ids, "attention_mask": input_mask, "token_type_ids": token_type_ids}
        result = model(inputs)
    ...
    def create_and_check_for_pretraining(
        ...
        model = TFRFFNBertForPreTraining(config=config)
        inputs = {"input_ids": input_ids, "attention_mask": input_mask, "token_type_ids": token_type_ids}
        result = model(inputs)
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = TFRFFNBertForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = TFRFFNBertForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = TFRFFNBertForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = TFRFFNBertForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_tf
class TFRFFNBertModelTest(TFModelTesterMixin, TFCoreModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = TFRFFNBertModelTester(self)
    ...
    def test_model_from_pretrained(self):
        model = TFRFFNBertModel.from_pretrained("jplu/tiny-tf-rffnbert-random")
        self.assertIsNotNone(model)

    def test_model_common_attributes(self):
        config, inputs_dict = self.model_tester.prepare_config_and_inputs_for_common()
        list_lm_models = [TFRFFNBertForMaskedLM, TFRFFNBertForPreTraining, TFRFFNBertLMHeadModel]
    ...
    def test_custom_load_tf_weights(self):
        model, output_loading_info = TFRFFNBertForTokenClassification.from_pretrained(
            "jplu/tiny-tf-rffnbert-random", output_loading_info=True
        )
...
@require_tf
class TFRFFNBertModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = TFRFFNBertForPreTraining.from_pretrained("lysandre/tiny-rffnbert-random")
