...
CONFIG_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("hubert", "HubertConfig"),
        ("bert", "BertConfig"),
        ("rffnbert", "RFFNBertConfig"),
        ("resbert", "ResbertConfig"),
        ("ubert", "UbertConfig"),
...
CONFIG_ARCHIVE_MAP_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("rffnbert", "RFFNBERT_PRETRAINED_CONFIG_ARCHIVE_MAP"),
        ("resbert", "RESBERT_PRETRAINED_CONFIG_ARCHIVE_MAP"),
        ("ubert", "UBERT_PRETRAINED_CONFIG_ARCHIVE_MAP"),
